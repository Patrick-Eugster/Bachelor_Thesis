...
#SBATCH --time=03:59:00        # <4h short-job tier. 1 plot; per plot ~ train 26m + seg ~30m + render/metrics/eval; ~2.5h expected.
...
#     sbatch /cluster/project/cropsci/peugste/wheat3dgs/scripts/fip_absgrad_seg_467_job.sh
# ============================================================================
set -euo pipefail
PLOTS=(plot_467)
