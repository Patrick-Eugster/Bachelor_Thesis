#!/bin/bash -l
#SBATCH -J fip_paper_bench_pp
#SBATCH --gpus=rtx_4090:1
#SBATCH --mem-per-cpu=8G
#SBATCH --cpus-per-task=6
#SBATCH --time=20:00:00       # ~1h40m per plot × 7 plots = ~12h; 20h gives safe headroom
#SBATCH --output=/cluster/project/cropsci/peugste/wheat3dgs/slurm_logs/fip_paper_bench_pp_%j.out
#SBATCH --error=/cluster/project/cropsci/peugste/wheat3dgs/slurm_logs/fip_paper_bench_pp_%j.err
...
for plot in plot_461 plot_462 plot_463 plot_464 plot_465 plot_466 plot_467; do
  ...
  python src/run_reconstruction.py \
    ...
    experiment_name=paper_bench_30k_pp
done
