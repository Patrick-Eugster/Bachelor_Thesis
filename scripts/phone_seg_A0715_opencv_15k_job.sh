#!/bin/bash -l
#SBATCH -J seg_A0715_ocv15k
#SBATCH --gpus=rtx_4090:1
#SBATCH --mem-per-cpu=8G       # 64 GB total — phone 3D seg decodes many full-res masks (RAM-heavy)
#SBATCH --cpus-per-task=8
#SBATCH --time=18:00:00        # 15k model (~1.55M gaussians): maskgen ~30 min + seg ~8-9h + eval; 18h ceiling
#SBATCH --output=/cluster/project/cropsci/peugste/wheat3dgs/slurm_logs/seg_A0715_ocv15k_%j.out
#SBATCH --error=/cluster/project/cropsci/peugste/wheat3dgs/slurm_logs/seg_A0715_ocv15k_%j.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=peugste@ethz.ch

# ============================================================================
# A/0715 seg — arm 3 of the 2x2: OPENCV baseline, 15k.
...
MASK_EXP=yolov5_pertile_ocv15k
SEG_EXP=ocv15k_yolov5_pertile
