#!/bin/bash -l
#SBATCH -J fip_rerender_metrics
#SBATCH --gpus=rtx_4090:1
#SBATCH --mem-per-cpu=8G
#SBATCH --cpus-per-task=6
#SBATCH --time=01:00:00
#SBATCH --output=/cluster/project/cropsci/peugste/wheat3dgs/slurm_logs/fip_rerender_metrics_%j.out
#SBATCH --error=/cluster/project/cropsci/peugste/wheat3dgs/slurm_logs/fip_rerender_metrics_%j.err
...
for plot in plot_461 plot_462 plot_463 plot_464 plot_465 plot_466 plot_467; do
  echo ""
  echo "========================================"
  echo "  $plot  (re-render + metrics on corrected eval split)"
  echo "========================================"
  python src/run_reconstruction.py \
    plot=$plot \
    run_train=false run_render=true run_metrics=true \
