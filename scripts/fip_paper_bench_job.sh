#!/bin/bash -l
#SBATCH -J fip_paper_bench
#SBATCH --gpus=rtx_4090:1
#SBATCH --mem-per-cpu=8G      # 48 GB total — FIP is only 36 images, plenty
#SBATCH --cpus-per-task=6
#SBATCH --time=18:00:00       # ~3h per plot × 6 plots = 18h
#SBATCH --output=/cluster/project/cropsci/peugste/wheat3dgs/slurm_logs/fip_paper_bench_%j.out
#SBATCH --error=/cluster/project/cropsci/peugste/wheat3dgs/slurm_logs/fip_paper_bench_%j.err
...
for plot in plot_462 plot_463 plot_464 plot_465 plot_466 plot_467; do
  echo ""
  echo "========================================"
  echo "  $plot  (FIP, 30k iterations)"
  echo "========================================"
