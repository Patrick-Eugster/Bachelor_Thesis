...
#SBATCH --time=03:59:00        # <4h short-job tier. 1 plot; per plot ~ train 26m + seg (pp-off, may be slower) ~40m + eval; ~2.5h expected.
...
#
# This script does plot 467 only. Submit:
#     sbatch /cluster/project/cropsci/peugste/wheat3dgs/scripts/fip_ppoff_seg_467_job.sh
# ============================================================================
set -euo pipefail
PLOTS=(plot_467)
