...
if __name__ == "__main__":
    ...
    parser.add_argument("--iou_threshold", type=float, default=0.6, help="IOU threshold for matching (thesis default 0.6)")
    ...
    parser.add_argument("--frustum_cull", action="store_true", default=True, help="Skip rendering a head into cameras where its Gaussians don't project (bit-identical/lossless). DEFAULT ON (thesis); use --no_frustum_cull to render every camera.")
