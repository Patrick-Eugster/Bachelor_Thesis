...
def readColmapCameras(cam_extrinsics, cam_intrinsics, images_folder, bboxes_folder, masks_folder):
    cam_infos = []
...
def readColmapSceneInfo(path, images, eval, llffhold=8, normalize=False, seg_dir=""):
    try:
    ...
    # bboxes and masks come from the detection results folder (separate from input images)
    seg_base   = seg_dir if seg_dir else path
