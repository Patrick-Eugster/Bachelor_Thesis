...
⚠️ **These no longer run as-is.** They were written as flat siblings of the live scripts and import
them by bare name (e.g. `from cct_forced_decode import …`, `from cctdecode import …`); moving them down
one folder breaks those imports. They are frozen records, not runnable tools.
